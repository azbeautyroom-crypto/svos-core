...
Voice attributes remain **draft** until the founder confirms it sounds like her; specifics beyond the
above are `NOT IN SOURCE — needs founder` (the founder's ear is the only test that counts).
